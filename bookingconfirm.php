...
<body>
    ...
    if($err_date >= 0) { 
    $sql1 = "INSERT into rentedcars(customer_username,car_id,driver_id,location,time,Aadhar_Card,booking_date,rent_start_date,rent_end_date,fare,charge_type,return_status) 
    VALUES('" . $customer_username . "','" . $car_id . "','" . $driver_id . "','" . $location . "','" . $time . "','" . $Aadhar_Card . "','" . date("Y-m-d") ."','" . $rent_start_date ."','" . $rent_end_date . "','" . $fare . "','" . $charge_type . "','" . $return_status . "')";
...
?>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center" style="color: green;"><i style="font-size:60px" class="fa">&#xf059;</i> Booking
                Pending.</h1>
        </div>
    </div>
    <br>
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                ...
                <br>
                <h3 style="color: orange;">Please read the following information about your order.</h3>
                <br>
            </div>
            ...
            <div>
                <a href="card.html"><button class="btn btn-warning pull-right">Pay Now</button></a>
            </div>
        </div>
