...
<body ng-app="">
    ...
    <div class="container" style="margin-top: 65px;">
        ...
        ?>
                    ...
                    <h5> Selected Car:&nbsp; <b>
                            <!--<input type="" name="Selected Car" value="">--><?php echo($car_name);?>
                        </b></h5>
                    <!-- </div> -->

                    <!-- <div class="form-group"> -->
                    <h5> Number Plate:&nbsp;<b>
                            <!--<input type="" name="Number Plate" value="">--><?php echo($car_nameplate);?>
                        </b></h5>
                    <!-- </div>      -->
                    <h5>PickUp Location: <input type="text" id="Name" name="location" placeholder="Enter your location"
                            required /> </h5>
                    <h5>PickUp Time: <input type="time" id="time" name="time" placeholder="00:00 AM/PM"
                            pattern="^\d{10}$" required /> </h5>
                    <h5>Aadhar Card: <input type="text" id="txtAadhar" onblur="AadharValidate();" name="Aadhar_Card"
                            placeholder="Enter aadhar id" required /> </h5>
                    ...
                    <label for="img">
                        <h5>Upload Aadhar Card: <input type="file" id="img" name="img" accept="image/*"></h5>
                    </label>
                    <br>
