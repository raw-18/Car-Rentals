...
$query = "INSERT into driver(driver_name,dl_number,driver_phone,driver_address,driver_gender,driver_password,client_username,driver_availability) VALUES('" . $driver_name . "','" . $dl_number . "','" . $driver_phone . "','" . $driver_address . "','" . $driver_gender ."','" . $driver_password ."','" . $client_username ."','" . $driver_availability ."')";
$success = $conn->query($query);

if (!$success){ 
    $_SESSION['status'] = " Same driving license number already exists!";
    $_SESSION['status_code'] = "error";
    header("location: adddriver.php");
    ?>
    <!-- <div class="container">
        <div class="jumbotron" style="text-align: center;">
            Same driving license number already exists!
            <br><br>
            <a href="adddriver.php" class="btn btn-default"> Go Back </a>
        </div> -->
    <?php	
}
else {
    ...
    header("location: adddriver.php"); //Redirecting 
}
