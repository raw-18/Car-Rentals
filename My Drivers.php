    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <span class="text">My Drivers</span>
            </div>
            ...
            <div class="">
                <a href="pdf2.php" target="_blank"><span class="glyphicon glyphicon-log-out"></span> Make PDF</a>
                <!-- <form action="pdf.php">
        ...
        <div class="col-md-9" style="float: none; margin: 0 auto;">
            <div class="form-area" style="padding: 0px 0px 160px 0px;">
      ...
      $sql = "SELECT * FROM driver d WHERE d.client_username='$user_check' ORDER BY driver_id";
                        ...
                        <tr>
                            ...
                            <!-- <td>
                                <form action="delete.php" method="POST">
                                    <input type="text" name="delete_id" value="<?php echo $row['driver_id']; ?>">
                                    <button type="submit" name="register_delete_btn"
